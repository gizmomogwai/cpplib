...
class IMAGE_API JasperImageCodec : public ImageCodec {
  ...
  public:
    ...
    static int jasperRead(jas_stream_obj_t* jStream, char* buf, unsigned int cnt);

    static int jasperWrite(jas_stream_obj_t* jStream, const char* buf, unsigned int cnt);
