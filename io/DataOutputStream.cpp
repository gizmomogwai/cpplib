...
void DataOutputStream::writeBytes(unsigned char* data,
                                  int nOfBytes) throw(IOException) {
...
void DataOutputStream::writeShorts(short* data,
...
void DataOutputStream::writeUnsignedShorts(
    unsigned short* data, int nOfUnsignedShorts) throw(IOException) {
...
void DataOutputStream::writeLine() throw(IOException) { write('\n'); }
