...
ByteArrayOutputStream::ByteArrayOutputStream(long _initialSize, bool clear) : written(0) {
...
void ByteArrayOutputStream::write(DataBuffer* b, int offset, int length) 
  throw (IOException) {
...
unsigned int ByteArrayOutputStream::getBytesWritten() {
  return written;
}

ByteDataBuffer& ByteArrayOutputStream::getData() {
  return *output;
}
